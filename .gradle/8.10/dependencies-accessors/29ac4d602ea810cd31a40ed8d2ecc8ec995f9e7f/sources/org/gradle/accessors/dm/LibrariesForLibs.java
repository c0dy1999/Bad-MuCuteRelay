...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>minecraftauth</b> with <b>net.raphimc:MinecraftAuth</b> coordinates and
     * with version reference <b>minecraft.auth</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getMinecraftauth() {
        return create("minecraftauth");
    }

    /**
     * Group of libraries at <b>bedrock</b>
     */
    ...
    public static class BedrockLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>codec</b> with <b>org.cloudburstmc.protocol:bedrock-codec</b> coordinates and
         * with version reference <b>bedrock.protocol</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Dependency provider for <b>common</b> with <b>org.cloudburstmc.protocol:common</b> coordinates and
         * with version reference <b>bedrock.protocol</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCommon() {
            return create("bedrock.common");
        }

        /**
         * Dependency provider for <b>connection</b> with <b>org.cloudburstmc.protocol:bedrock-connection</b> coordinates and
         * with version reference <b>bedrock.protocol</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class JacksonLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>jackson.databind</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class Log4jLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>bom</b> with <b>org.apache.logging.log4j:log4j-bom</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final BedrockVersionAccessors vaccForBedrockVersionAccessors = new BedrockVersionAccessors(providers, config);
        private final JacksonVersionAccessors vaccForJacksonVersionAccessors = new JacksonVersionAccessors(providers, config);
        private final MinecraftVersionAccessors vaccForMinecraftVersionAccessors = new MinecraftVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>log4j</b> with value <b>2.24.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.bedrock</b>
         */
        public BedrockVersionAccessors getBedrock() {
            return vaccForBedrockVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.minecraft</b>
         */
        public MinecraftVersionAccessors getMinecraft() {
            return vaccForMinecraftVersionAccessors;
        }

    }

    public static class BedrockVersionAccessors extends VersionFactory  {
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getProtocol() { return getVersion("bedrock.protocol"); }
    ...
    public static class JacksonVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jackson.databind</b> with value <b>2.15.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDatabind() { return getVersion("jackson.databind"); }

    }

    public static class MinecraftVersionAccessors extends VersionFactory  {

        public MinecraftVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>minecraft.auth</b> with value <b>4.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAuth() { return getVersion("minecraft.auth"); }
